...
/**
 * Page hero: copy left, image right, on a navy gradient.
 *
...
export function ServicesHero() {
  return (
    ...
    >
      ...
      <Container>
        {/* Light variant: the default breadcrumb colours are tuned for a white
            page and would nearly vanish on navy. */}
        ...
        <div className="mt-10 grid items-center gap-12 lg:grid-cols-[52fr_48fr] lg:gap-16">
          <div>
            ...
            <Heading id="services-hero-heading" level={1} size="section" className="mt-5">
