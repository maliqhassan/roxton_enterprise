...
/**
 * Inset navy conversion panel: soft glows, hollow-out primary action,
 * secondary that fills as glass, and a row of trust badges.
 *
 * Shared so every page closes the same way instead of each inventing an
 * ending. The homepage and services page still hold their own copies and can
 * switch to this without changing how they look.
 *
 * A Server Component; the button hovers are CSS states, so the only
 * JavaScript is the Reveal leaves. The glows are static — they used to drift
 * on --animate-drift, but a 26rem circle under a 90px blur cannot stay on the
 * compositor while it transforms, so every frame repainted a huge filtered
 * surface. Removing the motion is what made scrolling smooth.
 */
        ...
        <Reveal variant="fade-up" delay={0.3}>
          <div className="mt-10 flex flex-col items-stretch justify-center gap-4 sm:flex-row sm:items-center">
            ...
            <Link
              ...
              // The outline variant floods navy by default, invisible on this
              // panel — overridden to translucent white so the fill reads as
              // glass, with the blur completing it.
              className={cn(
